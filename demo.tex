...
\begin{frame}{带版权信息的图片}
	\begin{figure}
		\centering
		\includegraphicscopyright[width=0.75\linewidth]{img/photo.jpg}{版权属于 \href{http://netzlemming.deviantart.com/}{Netzlemming}, \href{http://creativecommons.org/licenses/by-nc/3.0/}{CC BY-NC 3.0 License}}
	\end{figure}
\end{frame}
